    ...
    <div x-data="{ sidebarOpen: false }" class="min-h-full">
                        ...
                        <div class="flex items-center h-16">
                            <div class="flex items-center space-x-3">
                                <div class="flex items-center justify-center w-10 h-10 rounded-xl bg-gradient-to-r from-orange-400 to-pink-600">
                                    <i class="text-lg text-white fas fa-utensils"></i>
                                </div>
        ...
        <div class="lg:pl-72">
            ...
            <div class="sticky top-0 z-40 flex items-center h-16 px-4 bg-white border-b border-gray-200 shadow-sm shrink-0 gap-x-4 sm:gap-x-6 sm:px-6 lg:px-8">
                ...
                <div class="flex self-stretch flex-1 gap-x-4 lg:gap-x-[820px]">
                    <form class="relative flex flex-1 max-w-md" action="#" method="GET">
                        <label for="search-field" class="sr-only">Pesquisar</label>
                        <i class="absolute inset-y-0 left-0 flex items-center w-5 h-full pl-3 text-gray-400 pointer-events-none top-6 fas fa-search"></i>
                        <input id="search-field" class="block w-full h-full py-0 pl-10 pr-0 text-gray-900 border-0 placeholder:text-gray-400 focus:ring-0 sm:text-sm" placeholder="Pesquisar..." type="search" name="search">
                    </form>
