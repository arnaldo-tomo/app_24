    ...
    <main class="py-10">
        <div class="px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                ...
                <p class="mt-2 text-sm text-gray-700">Preencha as informações para criar uma nova categoria de restaurante</p>
            </div>
                        ...
                        <div class="p-4 border border-gray-200 rounded-lg bg-gray-50">
                            ...
                            <div class="inline-flex items-center px-4 py-2 bg-white border border-gray-300 rounded-lg shadow-sm">
                                <div class="flex items-center justify-center w-8 h-8 mr-3 bg-orange-100 rounded-lg">
                                    <span id="preview-icon" class="text-lg">🍽️</span>
                                </div>
                                <span id="preview-name" class="text-sm font-medium text-gray-900">Nome da Categoria</span>
                                <span id="preview-status" class="ml-2 inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">
